 ...
 * @author spley
 */
public class TutoPerfilEstudiante extends javax.swing.JFrame {

    /**
     * Creates new form TutoPerfilEstudiante
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TutoPerfilEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TutoPerfilEstudiante().setVisible(true);
            }
        });
    }
